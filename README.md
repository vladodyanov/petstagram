# petstagram
The Petragram project encompasses various features, including user registration, login, and logout capabilities. Users can add pets to their profiles, upload photos of their pets, and explore a collective display of all pet photos. 
...
## General Information
The project's functionalities includes user registration, signin, and signout features. Each registered user will have the ability to add pets to their profile and upload captivating photos of their pets.
